...
// ─── GET — fetch current Purview integration config ───────────────────────────
...
// ─── POST — save Purview credentials (shares Azure integration record) ─────────
...
// ─── DELETE — remove Purview integration config ────────────────────────────────
