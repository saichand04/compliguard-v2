...
import { runEntraChecks } from '@/lib/microsoft/entra'
...
export async function POST(req: NextRequest) {
  ...
  try {
    // Get stored integration credentials
    ...
    if (integration?.encryptedCredentials) {
      ...
      // Allow inline credentials for ad-hoc scans
    ...
    // Run all Entra checks
    const checkResults = await runEntraChecks(tenantId, clientId, clientSecret)
    ...
    console.error('[entra/scan/POST]', err)
